package com.luminarymom.api;

import com.luminarymom.api.Security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/quotes").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/quotes/**").authenticated()
