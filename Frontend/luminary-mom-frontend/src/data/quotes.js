export const categories = [
  ...
  { id: 'rest',        name: 'Rest',               emoji: '💤', theme: 'blush'    },
  { id: 'self-care',   name: 'Self-Care',          emoji: '🫶', theme: 'lavender' },
...
export const quotes = [
  ...
  { id: 2,  text: "Almost everything will work again if you unplug it for a few minutes — including you.",                                           author: "Anne Lamott",      category: "rest"       },
  { id: 3,  text: "Healing is not linear. Be gentle with yourself.",                                                                                 author: "Unknown",          category: "healing"    },
  { id: 4,  text: "You cannot pour from an empty cup. Take care of yourself first.",                                                                 author: "Unknown",          category: "self-care"  },
  ...
  { id: 12, text: "Rest is not idleness. It is the key to a full life.",                                                                             author: "Unknown",          category: "rest"       },
